...
function PetCard({ pet }) {
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden pet-card">
      <div className="relative">
        ...
        />
        <button className="absolute top-3 right-3 bg-white p-2 rounded-full shadow-md hover:bg-gray-50 transition-colors">
      ...
      <div className="p-6">
        ...
        <Link
          to={`/pet/${pet.id}`}
          className="block w-full text-center bg-primary-600 text-white py-2.5 rounded-lg hover:bg-primary-700 transition-colors font-medium"
        >
          Ver detalhes
        </Link>
      </div>
